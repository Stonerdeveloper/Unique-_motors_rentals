...
function AdminBookingsPage() {
    ...
    async function fetchBookings() {
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("bookings").select("*, cars(name, brand)").order("created_at", {
            ascending: false
        });
...
_s(AdminBookingsPage, "Psci+SlYSbFjjSpa/U60G89XZZ4=");
...
//# sourceMappingURL=_aa8eb211._.js.map